...
- Due to lack of compute on free tier of cloud services, we had to learn to work with quantized models on local machines to make it possible to produce highly accurate results. Demo of the chatbot can be seen in our youtube video.
